...
def sample_hf_reasoning_requests(
    dataset_path: str,
    dataset_subset: str,
    dataset_split: str,
    num_requests: int,
...
def main(args: argparse.Namespace):
    ...
    elif args.dataset_name == "hf_reasoning":
        input_requests = sample_hf_reasoning_requests(
            dataset_path=args.dataset_path,
            dataset_subset=args.hf_subset,
            dataset_split=args.hf_split,
            num_requests=args.num_prompts,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="sharegpt",
        choices=["sharegpt", "sonnet", "random", "hf", "hf_reasoning"],
